        ...
        if (lastfmStatusField) {
            ...
            function updateDOM(topTrack, isTrackPlaying) {
                ...
                if (isTrackPlaying) {
                    ...
                    lastfmStatusField.innerHTML = `${getFriendlyTimePeriod(config.period)} I've mainly been listening to <a href="${trackUrl}" target="_blank"><span>${trackTitle}</span></a> by <span>${trackArtist}</span>. `;
                }
            }
        }
    };
